    ...
    ESX.UI.Menu.Open(
        ...
        ESX.UI.Menu.Open(
            ...
            if data.current.value == 'Buy_Stock' then
                TriggerServerEvent('esx_stock:transactionstock',currentstock, currentstockvalue, stockamount, true)
            elseif data.current.value == 'Sell_Stock' then
                TriggerServerEvent('esx_stock:transactionstock',currentstock, currentstockvalue, stockamount, false)
            end
            ESX.UI.Menu.CloseAll()
        end)
    end)
